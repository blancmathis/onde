...
final class LivingV3Tests: XCTestCase {
    ...
    func testThirteenProfilesAndDifferentFocusChoices() throws {
        XCTAssertEqual(SoundProfile.all.count, 13)
        XCTAssertEqual(SoundProfile.all.filter { $0.mode == .focus }.count, 10)
