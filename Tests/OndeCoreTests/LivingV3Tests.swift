...
final class LivingV3Tests: XCTestCase {
    ...
    func testNineProfilesAndDifferentFocusChoices() throws {
        XCTAssertEqual(SoundProfile.all.count, 9)
        XCTAssertEqual(SoundProfile.all.filter { $0.mode == .focus }.count, 6)
